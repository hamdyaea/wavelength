...
freq_var = tk.StringVar(value="145.800")  # Variable pour le champ de saisie et le curseur
...
freq_slider = ttk.Scale(frame, from_=1.0, to=1000.0, orient=tk.HORIZONTAL, variable=freq_var, command=on_frequency_change)
